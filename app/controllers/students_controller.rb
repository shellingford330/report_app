...
class StudentsController < ApplicationController
  ...
  before_action :already_logged_in, only: %i[login_form login]
  before_action :owner_logged_in,   only: %i[destroy upgrade]
  before_action :correct_student_or_admin, only: %i[edit update]
